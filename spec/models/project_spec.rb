...
describe "Strategy Attribute Requirements on Create", :type => :model do
  context "validation tests" do
    ...
    it "should not be able to save strategy when title missing" do
      strategy = Strategy.new(description: "Some description content goes here", description: "Content of the description", agent: "some agent", map: "some map", side: "some side", difficulty: 1)
